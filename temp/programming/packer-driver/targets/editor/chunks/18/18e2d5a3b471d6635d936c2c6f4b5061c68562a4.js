    ...
    execute: function () {
      ...
      _export("SimpleExperienceOrb", SimpleExperienceOrb = (_dec = ccclass('SimpleExperienceOrb'), _dec(_class = (_class2 = class SimpleExperienceOrb extends Component {
        ...
        update(dt) {
          ...
          const currentPos = this.node.position; // 磁力吸引效果
          ...
          const newPos = new Vec3(currentPos.x + this._velocity.x * dt, currentPos.y + this._velocity.y * dt, currentPos.z); // 边界检查 - 防止飞出屏幕
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          const otherNode = otherCollider.node; // 检查是否被挡板收集
