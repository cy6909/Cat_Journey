System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfEnhancedBossController(extras) {
    _reporterNs.report("EnhancedBossController", "../gameplay/EnhancedBossController", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfEnhancedBrick(extras) {
    _reporterNs.report("EnhancedBrick", "../gameplay/EnhancedBrick", _context.meta, extras);
  }

  function _reportPossibleCrUseOfBrickType(extras) {
    _reporterNs.report("BrickType", "../gameplay/EnhancedBrick", _context.meta, extras);
  }

  function _reportPossibleCrUseOfEnhancedBall(extras) {
    _reporterNs.report("EnhancedBall", "../gameplay/EnhancedBall", _context.meta, extras);
  }
    ...
    execute: function () {
      ...
      _export("EliteAndHiddenBossManager", EliteAndHiddenBossManager = (_dec = ccclass('EliteAndHiddenBossManager'), _dec2 = property({
        ...
        generateEliteLevel(eliteType, chapter, levelNumber) {
          ...
          const eliteDifficulty = baseDifficulty * config.difficultyMultiplier; // Generate elite-specific brick layout
        ...
        createEliteBrickLayout(config, difficulty) {
          ...
          const normalCount = brickCount - specialCount; // Create primary special bricks
          ...
          for (let i = 0; i < secondaryCount; i++) {
            const randomSecondary = config.secondaryBrickTypes[Math.floor(Math.random() * config.secondaryBrickTypes.length)];
        ...
        activateFortressDefense(difficulty) {
          ...
          this.schedule(() => {
            ...
            const allBricks = ((_this$node$parent = this.node.parent) == null ? void 0 : _this$node$parent.getComponentsInChildren(_crd && EnhancedBrick === void 0 ? (_reportPossibleCrUseOfEnhancedBrick({
              error: Error()
            }), EnhancedBrick) : EnhancedBrick)) || [];
            const activeBricks = allBricks.filter(brick => brick.node.active && brick.health > 0); // Create shield effect for 30% of remaining bricks
        ...
        activateSpeedPressure(difficulty) {
          ...
          this.schedule(() => {
            ...
            const allBalls = ((_this$node$parent2 = this.node.parent) == null ? void 0 : _this$node$parent2.getComponentsInChildren(_crd && EnhancedBall === void 0 ? (_reportPossibleCrUseOfEnhancedBall({
              error: Error()
        ...
        activateRegenerationField(difficulty) {
          ...
          this.schedule(() => {
            ...
            const allBricks = ((_this$node$parent3 = this.node.parent) == null ? void 0 : _this$node$parent3.getComponentsInChildren(_crd && EnhancedBrick === void 0 ? (_reportPossibleCrUseOfEnhancedBrick({
              error: Error()
            }), EnhancedBrick) : EnhancedBrick)) || [];
        ...
        activateElementalChaos(difficulty) {
          ...
          this.schedule(() => {
            ...
            const effectRadius = 100 + difficulty * 20; // Random position in game area
        ...
        activateGravityChaos(difficulty) {
          ...
          this.schedule(() => {
            const randomGravity = gravityDirections[Math.floor(Math.random() * gravityDirections.length)]; // Apply gravity change (would need physics world access)
        ...
        activateTimeChaos(difficulty) {
          ...
          this.schedule(() => {
            const newTimeScale = speedVariations[Math.floor(Math.random() * speedVariations.length)]; // Apply time scale change (would affect all game objects)
        ...
        activatePhaseShifting(difficulty) {
          ...
          this.schedule(() => {
            ...
            const allBricks = ((_this$node$parent4 = this.node.parent) == null ? void 0 : _this$node$parent4.getComponentsInChildren(_crd && EnhancedBrick === void 0 ? (_reportPossibleCrUseOfEnhancedBrick({
              error: Error()
            }), EnhancedBrick) : EnhancedBrick)) || [];
        ...
        activateMagneticChaos(difficulty) {
          ...
          this.schedule(() => {
            ...
            for (let i = 0; i < fieldCount; i++) {
              ...
              const fieldY = Math.random() * 300 + 150; // Create magnetic field effect
        ...
        activateShieldNetwork(difficulty) {
          ...
          const allBricks = ((_this$node$parent5 = this.node.parent) == null ? void 0 : _this$node$parent5.getComponentsInChildren(_crd && EnhancedBrick === void 0 ? (_reportPossibleCrUseOfEnhancedBrick({
            error: Error()
          }), EnhancedBrick) : EnhancedBrick)) || [];
        ...
        activateVoidSpread(difficulty) {
          ...
          this.schedule(() => {
            ...
            const allBricks = ((_this$node$parent6 = this.node.parent) == null ? void 0 : _this$node$parent6.getComponentsInChildren(_crd && EnhancedBrick === void 0 ? (_reportPossibleCrUseOfEnhancedBrick({
              error: Error()
            }), EnhancedBrick) : EnhancedBrick)) || [];
            const voidBricks = allBricks.filter(brick => brick.node.active && brick.brickType === (_crd && BrickType === void 0 ? (_reportPossibleCrUseOfBrickType({
              error: Error()
            }), BrickType) : BrickType).VOID);
        ...
        spawnHiddenBoss(bossType, chapter) {
          ...
          const bossController = boss.getComponent(_crd && EnhancedBossController === void 0 ? (_reportPossibleCrUseOfEnhancedBossController({
            error: Error()
        ...
        applyElementalEffect(element, position, radius, difficulty) {
          ...
          const allBricks = ((_this$node$parent7 = this.node.parent) == null ? void 0 : _this$node$parent7.getComponentsInChildren(_crd && EnhancedBrick === void 0 ? (_reportPossibleCrUseOfEnhancedBrick({
            error: Error()
          }), EnhancedBrick) : EnhancedBrick)) || [];
          const allBalls = ((_this$node$parent8 = this.node.parent) == null ? void 0 : _this$node$parent8.getComponentsInChildren(_crd && EnhancedBall === void 0 ? (_reportPossibleCrUseOfEnhancedBall({
            error: Error()
          }), EnhancedBall) : EnhancedBall)) || []; // Apply effects based on element type

          [...allBricks, ...allBalls].forEach(target => {
            const distance = Math.sqrt(Math.pow(target.node.position.x - position.x, 2) + Math.pow(target.node.position.y - position.y, 2));
...
//# sourceMappingURL=1fa19b29d68ab37b6eff2fb0474b4961507f9410.js.map