    ...
    execute: function () {
      ...
      _export("DevToolsUI", DevToolsUI = (_dec = ccclass('DevToolsUI'), _dec2 = property(EditBox), _dec3 = property(Button), _dec4 = property(Label), _dec5 = property(Node), _dec(_class = (_class2 = class DevToolsUI extends Component {
        ...
        onApplyButtonClick() {
          ...
          const level = parseInt(this.levelInput.string); // 验证输入
          ...
          const config = (_crd && DifficultyCalculator === void 0 ? (_reportPossibleCrUseOfDifficultyCalculator({
            error: Error()
        ...
        refreshCurrentLevelInfo() {
          ...
          if (gameManager) {
            const currentLevel = gameManager.level || 1;
            const config = (_crd && DifficultyCalculator === void 0 ? (_reportPossibleCrUseOfDifficultyCalculator({
              error: Error()
