    ...
    execute: function () {
      ...
      _export("LevelSoundManager", LevelSoundManager = (_dec = ccclass('LevelSoundManager'), _dec2 = property(AudioSource), _dec3 = property(AudioSource), _dec4 = property(AudioSource), _dec(_class = (_class2 = (_class3 = class LevelSoundManager extends Component {
        ...
        stopAmbientLoop() {
          ...
          const config = this._soundConfigs.get(this._currentAmbientLoop);
        ...
        setupAudioSource(source, config, clip, position) {
          ...
          if (config.spatialAudio && position && this.enableSpatialAudio) {
            ...
            const distance = Math.sqrt(Math.pow(position.x - screenCenter.x, 2) + Math.pow(position.y - screenCenter.y, 2)); // 距离衰减
        ...
        getDebugInfo() {
          ...
          const ambientPlaying = (_this$ambientSource = this.ambientSource) != null && _this$ambientSource.playing ? this._currentAmbientLoop : 'None';
...
//# sourceMappingURL=4e3327beee53266608a9e59decfcd53ae6a941ee.js.map