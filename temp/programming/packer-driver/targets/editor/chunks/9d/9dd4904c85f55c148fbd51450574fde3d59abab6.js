    ...
    execute: function () {
      ...
      _export("ExperienceOrb", ExperienceOrb = (_dec = ccclass('ExperienceOrb'), _dec(_class = (_class2 = class ExperienceOrb extends Component {
        ...
        updateMagnetism(dt) {
          ...
          let closestDistance = Infinity; // Check distance to paddle
        ...
        attractToTarget(target) {
          ...
          const currentPos = this.node.position;
          const targetPos = target.position; // Calculate direction to target
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          const otherNode = otherCollider.node; // Check if collected by paddle or core
...
//# sourceMappingURL=9dd4904c85f55c148fbd51450574fde3d59abab6.js.map