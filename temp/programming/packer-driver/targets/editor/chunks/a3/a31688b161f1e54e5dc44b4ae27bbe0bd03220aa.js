    ...
    execute: function () {
      ...
      _export("Ball", Ball = (_dec = ccclass('Ball'), _dec(_class = (_class2 = class Ball extends Component {
        ...
        launch() {
          ...
          const velocity = new Vec2(Math.cos(angle) * this.initialSpeed, Math.sin(angle) * this.initialSpeed);
...
//# sourceMappingURL=a31688b161f1e54e5dc44b4ae27bbe0bd03220aa.js.map