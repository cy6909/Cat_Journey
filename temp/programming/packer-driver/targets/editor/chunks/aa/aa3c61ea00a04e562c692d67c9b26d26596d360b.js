    ...
    execute: function () {
      ...
      _export("EnhancedBall", EnhancedBall = (_dec = ccclass('EnhancedBall'), _dec2 = property({
        ...
        applyIceEffect(collider, position) {
          ...
          for (const obj of nearbyObjects) {
            const ball = obj.getComponent('EnhancedBall');
        ...
        applyHealingEffect() {
          ...
          // Heal the paddle
          const paddle = (_this$node$parent = this.node.parent) == null ? void 0 : _this$node$parent.getComponentInChildren('EnhancedPaddleController');
        ...
        applyRandomEffect(collider, position) {
          ...
          const effects = [() => this.applyFireEffect(collider, position), () => this.applyIceEffect(collider, position), () => this.applyElectricEffect(collider, position), () => this.applyExplosiveEffect(position), () => this.applySplittingEffect(), () => this.applyHealingEffect()];
        ...
        findObjectsInRadius(center, radius) {
          ...
          const allObjects = ((_this$node$parent2 = this.node.parent) == null ? void 0 : _this$node$parent2.children) || [];
          const nearby = [];
...
//# sourceMappingURL=aa3c61ea00a04e562c692d67c9b26d26596d360b.js.map