      ...
      _export("SaveManager", SaveManager = (_dec = ccclass('SaveManager'), _dec(_class = (_class2 = (_class3 = class SaveManager extends Component {
        ...
        savePlayerProgress() {
          try {
            ...
            const saveData = JSON.stringify(this._playerProgress); // 保存到本地存储
        ...
        saveRunProgress() {
          try {
            ...
            const saveData = JSON.stringify(this._currentRunProgress); // 保存到本地存储
        ...
        defeatBoss(bossId, isHidden = false) {
          if (this._playerProgress) {
            if (isHidden) {
...
//# sourceMappingURL=b13cbfbe6404fa508f23da8e5f3f2722672fc42a.js.map