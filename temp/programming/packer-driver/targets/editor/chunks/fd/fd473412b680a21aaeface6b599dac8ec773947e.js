    ...
    execute: function () {
      ...
      _export("MainMenuButton", MainMenuButton = (_dec = ccclass('MainMenuButton'), _dec(_class = (_class2 = class MainMenuButton extends Component {
        ...
        playHoverAnimation(isEntering) {
          const targetScale = isEntering ? new Vec3(1.05, 1.05, 1) : this.originalScale;
        ...
        playPressAnimation(isPressed) {
          const targetScale = isPressed ? new Vec3(0.98, 0.98, 1) : this.originalScale;
        ...
        playCustomClickEffect(intensity = 1.0) {
...
//# sourceMappingURL=fd473412b680a21aaeface6b599dac8ec773947e.js.map