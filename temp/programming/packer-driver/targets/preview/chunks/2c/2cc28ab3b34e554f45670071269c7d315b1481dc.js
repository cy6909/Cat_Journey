    ...
    execute: function () {
      ...
      _export("MainMenuController", MainMenuController = (_dec = ccclass('MainMenuController'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class MainMenuController extends Component {
        ...
        fadeOutAndLoadScene(sceneName) {
          ...
          if (audioManager) {
            ...
            audioManager.fadeBGM(0, 1.0, () => {
              var mgr = (_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
                error: Error()
              }), AudioManager) : AudioManager).instance;
        ...
        switchBackgroundTheme(themeName) {
          ...
          var currentBgComponents = ['StarFieldBackground', 'ForestThemeBackground', 'SnowMountainBackground', 'AbyssBackground'];
          currentBgComponents.forEach(componentName => {
            var component = this.backgroundLayer.getComponent(componentName);
...
//# sourceMappingURL=2cc28ab3b34e554f45670071269c7d315b1481dc.js.map