    ...
    execute: function () {
      ...
      _export("CoreController", CoreController = (_dec = ccclass('CoreController'), _dec(_class = (_class2 = class CoreController extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          var otherNode = otherCollider.node; // Ball hit core directly (missed paddle)

          if (otherNode.name.includes('Ball')) {
            var ballScript = otherNode.getComponent('Ball');
            var damage = ballScript ? ballScript.getDamage() : 1;
            this.takeDamage(damage, 'Ball impact');
          } // Experience orb collection


          if (otherNode.name.includes('ExperienceOrb')) {
            var xpValue = 10; // Could be configurable per orb type
          ...
          if (otherNode.name.includes('BossAttack')) {
            var attackDamage = 2; // Boss attacks are stronger
        ...
        updateHealthDisplay() {
          ...
          if (sprite) {
            ...
            var healthPercent = this._currentCoreHealth / this.maxCoreHealth;
...
//# sourceMappingURL=51e359d43c6bcd3fe79d65600ddb3850c7dff632.js.map