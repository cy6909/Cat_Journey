  ...
  return {
    ...
    execute: function () {
      ...
      _export("AudioManager", AudioManager = (_dec = ccclass('AudioManager'), _dec2 = property(AudioSource), _dec3 = property(AudioSource), _dec4 = property([AudioClip]), _dec(_class = (_class2 = (_class3 = class AudioManager extends Component {
        ...
        fadeBGM(targetVolume, duration, callback) {
          if (duration === void 0) {
            duration = 1.0;
          }
          ...
          var startVolume = this.bgmPlayer.volume;
          var volumeDiff = targetVolume - startVolume;
          var steps = duration * 60; // 假设60FPS

          var volumeStep = volumeDiff / steps;
          var currentStep = 0;
        ...
        playSFX(clipName, volume) {
          ...
          var clip = this.sfxClips.find(c => c && c.name === clipName);
        ...
        playUISFX(actionType) {
          ...
          var clipName = sfxMap[actionType];
...
//# sourceMappingURL=5c36c4b3b5cf72d11abf811abfc0882b3d46b37a.js.map