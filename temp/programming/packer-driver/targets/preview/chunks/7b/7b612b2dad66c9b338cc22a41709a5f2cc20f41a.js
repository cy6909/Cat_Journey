    ...
    execute: function () {
      ...
      _export("BossController", BossController = (_dec = ccclass('BossController'), _dec(_class = (_class2 = class BossController extends Component {
        ...
        updateMovement(dt) {
          ...
          var newX = currentPos.x + this._moveDirection * this.moveSpeed * dt; // Bounce off screen edges
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          var otherNode = otherCollider.node; // Check if hit by ball
...
//# sourceMappingURL=7b612b2dad66c9b338cc22a41709a5f2cc20f41a.js.map