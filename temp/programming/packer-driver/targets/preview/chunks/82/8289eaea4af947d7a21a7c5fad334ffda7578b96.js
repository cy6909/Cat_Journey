    ...
    execute: function () {
      ...
      _export("Ball", Ball = (_dec = ccclass('Ball'), _dec(_class = (_class2 = class Ball extends Component {
        ...
        launchBall() {
          ...
          var baseAngle = Math.PI / 2; // 90度，向上

          var randomOffset = (Math.random() - 0.5) * (Math.PI / 6); // ±15度 = 30度范围

          var angle = baseAngle + randomOffset;
          var direction = new Vec2(Math.cos(angle), Math.sin(angle));
          this.launch(direction);
          console.log("Ball launched at angle: " + (angle * 180 / Math.PI).toFixed(1) + "\xB0");
        }
...
//# sourceMappingURL=8289eaea4af947d7a21a7c5fad334ffda7578b96.js.map