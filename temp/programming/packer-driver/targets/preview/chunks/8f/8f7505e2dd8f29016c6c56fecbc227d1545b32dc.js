    ...
    execute: function () {
      ...
      _export("LevelManager", LevelManager = (_dec = ccclass('LevelManager'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = (_class3 = class LevelManager extends Component {
        ...
        initializeLevel() {
          ...
          var currentLevel = gameManager.getLevel();
        ...
        spawnBoss() {
          ...
          var bossScript = this._bossNode.getComponent(_crd && BossController === void 0 ? (_reportPossibleCrUseOfBossController({
            error: Error()
          ...
          if (bossScript) {
            ...
            var level = gameManager ? gameManager.getLevel() : 1; // Scale boss health and damage with level

            var healthMultiplier = 1 + level / 10;
            var damageMultiplier = 1 + level / 20;
        ...
        applyBrickPressure(dt) {
          ...
          var adjustedSpeed = this.pressureMoveSpeed * Math.pow(this.pressureAcceleration, level / 5); // Move all bricks down

          var children = this.brickContainer.children;
          var paddleHit = false;

          for (var child of children) {
            var currentPos = child.position;
            var newY = currentPos.y - adjustedSpeed * dt;
        ...
        onBricksReachPaddle() {
          ...
          var remainingBricks = this.countRemainingBricks();
          var rowsRemaining = Math.ceil(remainingBricks / 8); // Assuming 8 bricks per row

          var damage = Math.max(1, rowsRemaining);
        ...
        adjustDifficulty(level) {
          ...
          var difficultyMultiplier = 1 + level / 10;
...
//# sourceMappingURL=8f7505e2dd8f29016c6c56fecbc227d1545b32dc.js.map