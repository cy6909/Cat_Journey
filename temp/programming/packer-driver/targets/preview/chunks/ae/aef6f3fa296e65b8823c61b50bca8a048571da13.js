    ...
    execute: function () {
      ...
      _export("ExperienceBar", ExperienceBar = (_dec = ccclass('ExperienceBar'), _dec2 = property(ProgressBar), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec(_class = (_class2 = class ExperienceBar extends Component {
        ...
        onExpChanged(data) {
          ...
          if (this.progressBar) {
            var targetProgress = data.progress;
        ...
        updateLevelDisplay(level) {
          if (this.levelLabel) {
            ...
            var bigScale = new Vec3(1.3, 1.3, 1);
            this.levelLabel.string = "Lv." + level;
        ...
        playLevelUpEffect() {
          ...
          var opacity = this.levelUpEffect.getComponent(UIOpacity);
        ...
        refreshDisplay() {
          ...
          var currentExp = this._expManager.getCurrentExp();

          var expToNext = this._expManager.getExpToNextLevel();

          var level = this._expManager.getCurrentLevel();
        ...
        setProgressBarColor(level) {
          ...
          var barSprite = this.progressBar.barSprite;
          if (!barSprite) return;
