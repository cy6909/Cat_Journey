System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfRelic(extras) {
    _reporterNs.report("Relic", "./RelicManager", _context.meta, extras);
  }
    ...
    execute: function () {
      ...
      _export("RelicUI", RelicUI = (_dec = ccclass('RelicUI'), _dec2 = property(Node), _dec3 = property(Label), _dec(_class = (_class2 = class RelicUI extends Component {
        ...
        updateRelicDisplay() {
          ...
          var activeRelics = this._relicManager.getActiveRelics();
        ...
        createRelicItem(relic) {
          ...
          var relicNode = new Node("Relic_" + relic.id);
          var label = relicNode.addComponent(Label);
...
//# sourceMappingURL=b0de871893185e567346916069b8c4e93dca9092.js.map