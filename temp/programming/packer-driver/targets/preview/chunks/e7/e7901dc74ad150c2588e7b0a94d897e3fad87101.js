    ...
    execute: function () {
      ...
      _export("EnhancedBossController", EnhancedBossController = (_dec = ccclass('EnhancedBossController'), _dec2 = property({
        ...
        scaleStatsForChapter() {
          var chapterMultiplier = 1 + (this.chapter - 1) * 0.5;
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          var ball = otherCollider.getComponent('EnhancedBall');
          ...
          var laser = otherCollider.getComponent('Laser');
        ...
        horizontalMovement(dt) {
          ...
          var velocity = Vec2.multiplyScalar(new Vec2(), new Vec2(this._moveDirection.x, 0), this.moveSpeed); // Bounce off screen edges
        ...
        floatingMovement(dt) {
          var time = this._specialTimer;
          var x = Math.sin(time * 2) * 150;
          var y = Math.cos(time * 1.5) * 50;
        ...
        updateAttackPatterns(dt) {
          ...
          for (var pattern of this._attackPatterns) {
        ...
        checkPhaseTransitions() {
          var newPhase = this._currentPhase;
        ...
        adjustAttackPatternsForPhase(phase) {
          var speedMultiplier = 1 + phase * 0.2;
          var damageMultiplier = 1 + phase * 0.3;
        ...
        regenerateShieldBricks() {
          ...
          var bricks = ((_this$node$parent = this.node.parent) == null ? void 0 : _this$node$parent.getComponentsInChildren(_crd && EnhancedBrick === void 0 ? (_reportPossibleCrUseOfEnhancedBrick({
            error: Error()
        ...
        createDefensiveBarrier() {
          ...
          var positions = [new Vec3(-100, -50, 0), new Vec3(100, -50, 0), new Vec3(-100, 50, 0), new Vec3(100, 50, 0)];

          for (var pos of positions) {
            var barrier = instantiate(this.brickPrefab);
            var brick = barrier.getComponent(_crd && EnhancedBrick === void 0 ? (_reportPossibleCrUseOfEnhancedBrick({
              error: Error()
            }), EnhancedBrick) : EnhancedBrick);
        ...
        createWindGust() {
          ...
          var balls = ((_this$node$parent2 = this.node.parent) == null ? void 0 : _this$node$parent2.getComponentsInChildren('EnhancedBall')) || [];
          var windForce = new Vec2(math.randomRangeInt(-500, 500), math.randomRangeInt(-200, 200));
        ...
        lightningStrike() {
          ...
          var paddleController = (_this$node$parent3 = this.node.parent) == null ? void 0 : _this$node$parent3.getComponentInChildren('EnhancedPaddleController');
        ...
        spawnBasicBricks() {
          ...
          for (var i = 0; i < 3; i++) {
            ...
            var randomX = math.randomRangeInt(-300, 300);
            var randomY = math.randomRangeInt(100, 300);
        ...
        spawnEliteBricks() {
          if (!this.brickPrefab) return;
          var eliteTypes = [(_crd && BrickType === void 0 ? (_reportPossibleCrUseOfBrickType({
            error: Error()
        ...
        getRandomElementalColor() {
          var colors = [new Color(255, 0, 0), // Red (Fire)
        ...
        updateMultiPhaseVisuals() {
          if (this._sprite) {
            var alpha = 150 + Math.sin(this._specialTimer * 4) * 50;
        ...
        onBossDefeated() {
          ...
          for (var obj of this._spawnedObjects) {
            if (obj && obj.isValid) {
              obj.destroy();
            }
          } // Notify GameManager
...
//# sourceMappingURL=e7901dc74ad150c2588e7b0a94d897e3fad87101.js.map